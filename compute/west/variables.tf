...
variable "terraform_state_dynamodb_table_name" {
  ...
  type        = string
  default     = "maxf-004-w2-SOWI-prod-terraform_statelock-use"
}

variable "terraform_state_bucket_name" {
  description = "name of the S3 bucket to store the terraform state"
  type        = string
  default     = "maxf-004-w2-SOWI-prod-tfstate-use-terraformstate-use"
}

variable "environment" {
  description = "Environment"
  type        = string
  default     = "maxf-004-w2-SOWI-prod-tfstate-use"
}
