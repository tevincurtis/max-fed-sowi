...
variable "terraform_state_dynamodb_table_name" {
  ...
  type        = string
  default     = "maxf-004-w2-SOWI-prod-terraform_statelock-usw"
}

variable "terraform_state_bucket_name" {
  description = "name of the S3 bucket to store the terraform state"
  type        = string
  default     = "maxf-004-w2-SOWI-prod-tfstate-usw-terraformstate-usw"
}

variable "environment" {
  description = "Environment"
  type        = string
  default     = "maxf-004-w2-SOWI-prod-tfstate-usw"
}

variable "availability_zone_1" {
  description = "1st availability_zone within USE maxf-XXX-w2-xxxx-prod VPC"
  type        = string
  default     = "us-west-2a"
}

variable "availability_zone_2" {
  description = "2nd availability_zone within USE maxf-XXX-w2-xxxx-prod VPC"
  type        = string
  default     = "us-west-2b"
}

variable "availability_zone_3" {
  description = "3rd availability_zone within USE maxf-XXX-w2-xxxx-prod VPC"
  type        = string
  default     = "us-west-2c"
}

variable "vpc_cidr_block_1" {
  description = "1st CIDR block for maxf-XXX-w2-xxxx-prod VPC"
  type        = string
}

variable "vpc_cidr_block_2" {
  description = "2nd CIDR block for maxf-XXX-w2-xxxx-prod VPC"
  type        = string
}

variable "vpc_cidr_block_3" {
  description = "3rd CIDR block for maxf-XXX-w2-xxxx-prod VPC"
  type        = string
}
variable "tools_vpc" {
...
variable "default_route_table_usw2" {
  description = "default_route_table_usw2"
  type        = string
}
variable "transit_gateway_id" {
  description = "transit-gateway-id for maxf-XXX-w2-xxxx-prod VPC"
  type        = string
}

variable "transit_gateway_route_table_id" {
  description = "transit_gateway_route_table_id for maxf-XXX-w2-xxxx-prod VPC"
  type        = string
}

variable "usw2_sg_ec2" {
  description = "004-w2-SOWI-ec2-sg VPC"
  type        = string
  default = "sg-08172d6dd46afde25"
}
variable "usw2_sg_rds" {
...
variable "vpc_id" {
  default = "vpc-086c01996dc02cd85"
}

variable "subnet_ids" {
  type    = list(any)
  default = ["subnet-0e998d36b4ac616b0","subnet-0c161f425f5ba5d4b"]
}

variable "security_groups_ids" {
  type    = list(any)
  default = ["sg-06d6d314a36abca08"]
}
...
variable "albs_with_certs" {
  ...
  default = {
    alb1 = {
      ...
      instance_LM025_id   = "i-0973733bc1b26eb68",
      instance_LM026_id = "i-03ef274e7d9a34869",
      instance_LM033_id   = "i-03e1f1e096a219c50",
      acm_cert_arn     = "arn:aws:acm:us-west-2:912042807419:certificate/6febf9ff-beaa-432f-bd6f-aa7b20692fc2",
      tg_port = "8443",
      tgbkp_port = "8443",
      bkp_protocol = "HTTPS",
